        ...
        <div className="fixed inset-0 z-50 flex flex-col px-6 pt-10 pb-8" style={{ background: PAPEL }}>
          ...
          {!premium ? (
            <div className="flex flex-col items-center justify-center flex-1 text-center gap-4">
              ...
              <p style={{ color: TINTA, fontFamily: fontDisplay, fontSize: 20 }}>Historial de menús</p>
              <p style={{ color: MALVA, fontFamily: fontBody, fontSize: 14 }}>Guarda y recupera todos tus menús anteriores con Rawku Premium.</p>
              <button onClick={() => { setSeccionActiva(null); setMostrarSuscripcion(true); }}
                style={{ background: ROSA, color: '#FFF', fontFamily: fontBody, fontWeight: 700, fontSize: 15, padding: '14px 28px', borderRadius: 14, border: 'none', cursor: 'pointer' }}>
      ...
      {seccionActiva === "analizar" && (
        <div className="fixed inset-0 z-50 flex flex-col px-6 pt-10 pb-8 overflow-y-auto cnl-pantalla-scroll" style={{ background: PAPEL }}>
          ...
          {!premium ? (
            <div className="flex flex-col items-center justify-center flex-1 text-center gap-4">
              <p style={{ fontSize: 36 }}>🔒</p>
              <p style={{ color: TINTA, fontFamily: fontDisplay, fontSize: 20 }}>Analizador nutricional</p>
              <p style={{ color: MALVA, fontFamily: fontBody, fontSize: 14 }}>Analiza en detalle los nutrientes de la dieta actual de tu perro con Rawku Premium.</p>
              <button onClick={() => { setSeccionActiva(null); setMostrarSuscripcion(true); }}
                style={{ background: ROSA, color: '#FFF', fontFamily: fontBody, fontWeight: 700, fontSize: 15, padding: '14px 28px', borderRadius: 14, border: 'none', cursor: 'pointer' }}>
                ✨ Prueba gratis 7 días
              </button>
