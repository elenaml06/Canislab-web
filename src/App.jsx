...
const CATEGORIAS_ESENCIALES = ["Hueso carnoso", "Pescados y mariscos", "Extras"];
    ...
    <div style={{ background: VIOLETA }} className="w-full px-6 pt-8 pb-7">
      <div className="flex items-center justify-between mb-5">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* ⚠️ AÑADIDO (5 agosto, madrugada) — pedido expreso: el menú
              lateral tenía que estar accesible desde el minuto uno, no
              solo después de generar un menú. Antes, estas 6 pantallas
              de crear el perfil no tenían ninguna forma de acceder a
              nada más. */}
          {onAbrirMenu && (
...
function VistaMenus({ menus, onVolver, modo, alimentosEvitados, patologias, nombrePerro, necesitaTransicion, dietaActual, categoriasDisponibles, perfil, derReal, etapaLabel, etapaCalculada, especiesExcluidas, pesoAdultoEsperado, edad, set, setFase }) {
    ...
    <div className="min-h-screen w-full flex flex-col" style={{ background: PAPEL }}>
      ...
      <div style={{ background: VIOLETA }} className="w-full px-6 pt-8 pb-6">
        {/* ⚠️ CORREGIDO (5 agosto, madrugada) — pedido expreso: esta era
            ...
            ningún sitio. Ahora el menú va SIEMPRE a la derecha, sin
            excepción -- y se quita de aquí la burbuja de mascota, que
            no hace nada funcional todavía (era solo una maqueta). */}
